...
interface ReadLock extends LockSimple {
   ...
   */
  default
  <R, E extends Throwable> R read(@NotNull trySupplier<R, E> run, @Nullable Function<E, R> catchby,
   ...
   */
  default
  <R, E extends Throwable> R read(@NotNull trySupplier<R, E> run, @Nullable Function<R, R> finaby) throws E
